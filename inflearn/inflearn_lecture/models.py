...
class myText(models.Model):
    ...
    lecture_vidio1=models.CharField(max_length=5000, null=True)
    lecture_title2=models.CharField(max_length=200, null=True)
    lecture_vidio2=models.CharField(max_length=5000, null=True)
    lecture_title3=models.CharField(max_length=200, null=True)
    lecture_vidio3=models.CharField(max_length=5000, null=True)
    lecture_title4=models.CharField(max_length=200, null=True)
    lecture_vidio4=models.CharField(max_length=5000, null=True)
